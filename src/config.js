...
export const USE_CASES = [
  ...
  },
  {
    ...
    subtitle: 'Respectful, locally tuned',
    description: 'Built for local context and tone. It recovers overdue payments while keeping every conversation respectful, so customers feel helped, not chased.',
    icon: 'public',
    color: '#E749A4',
